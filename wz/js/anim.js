...
function changeMessage() {
    var txtVal = ($("#message").val()).toLowerCase(); arr_Msg = txtVal; nMsgIndex = 0; strMsg = $("#message").val(); var regNoNumbers = new RegExp("([^a-z ])*", "gi"); strMsg = strMsg.replace(regNoNumbers, ""); $("#urlText").html("/www.feedtank.com/labs/html_canvas/?msg=" + escape(strMsg))
}
